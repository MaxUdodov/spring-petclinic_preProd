PetClinic is an application created to demonstrate the functionality of Spring. Using it functionality, I expanding this application and adding new features.
